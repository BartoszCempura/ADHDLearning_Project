...
namespace ADHDLaarning
{
    public partial class Main_Window : System.Windows.Forms.Form
    {
        ...
        {
            //----------------------------------------------------------------------------
            string musicDirectory = Path.Combine(Application.StartupPath, "Sounds"); // najbliższy folder gdzie są pliki dźwiękokwe
        ...
        private void ButtonStart_Click(object sender, EventArgs e)
        {
            ...
            if (MusicChoice.SelectedItem is string selectedFileName &&
                musicFiles.ContainsKey(selectedFileName))
            {
        ...
        private void PrzeliczNiezaznaczone()
{
        ...
        private void PlayAudio(string filePath)
        {
            try
            {
                // jeżeli dźwięk już gra , zatrzymaj go zanim uruchomisz kolejny
                if (player != null)
                {
                    player?.Stop();
                    player?.Dispose(); 
                ...
                // Tworzymy instancje SoundPlayer aby załadować i zagrac plik audio 
